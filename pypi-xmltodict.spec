...
Source0  : https://files.pythonhosted.org/packages/44/ea/9467a80e5d1722067ad235801883e6eb92f1665c2c629fea7d57fb52775e/xmltodict-0.14.0.tar.gz
...
%prep
%setup -q -n xmltodict-0.14.0
cd %{_builddir}/xmltodict-0.14.0
pushd ..
cp -a xmltodict-0.14.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728421200
